...
<div class="row">
	<div class="col-md-12">
		<div class="x_panel">
			...
			<div class="x_content">
				<form method="post" action="${pageContext.request.contextPath }/appInfo/showAppInfoList" >
			    ...
			    <ul>
					...
					<li>
						<div class="form-group">
							<label class="control-label col-md-3 col-sm-3 col-xs-12" id="secondLevel">二级分类</label>
							<div class="col-md-6 col-sm-6 col-xs-12">
					...
					<li>
						<div class="form-group">
							<label class="control-label col-md-3 col-sm-3 col-xs-12" id="thirdLevel">三级分类</label>
							<div class="col-md-6 col-sm-6 col-xs-12">
	...
	<div class="x_panel">
		<div class="x_content">
			...
			<div id="datatable-responsive_wrapper"
				...
				<div class="row">
					<div class="col-sm-12">
					<a href="${pageContext.request.contextPath}/appInfo/showAddAppInfoPage" class="btn btn-success btn-sm">新增APP基础信息</a>
